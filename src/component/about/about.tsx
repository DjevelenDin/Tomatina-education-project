...
const About = () => {
  ...
  return (
    <div className="aboutContainer">
      <h1>
        {t("about.pro")} <span className="greenTitle"> {t("about.tomat")}</span>
      </h1>
      ...
      <div className="secondBlock">
        ...
        <div className="textAbout">
          <p className="titleAbt"> {t("about.titleAbout")}</p>
          <p>{t("about.paragraph2")}</p>
        </div>
      </div>
      <div>
        <p className="titleForSecondBlock"> {t("about.why")} TOMATINA?</p>
      </div>
      <div className="containerAbout-2">
        <div className="firstBlockIcons">
          <div className="product">
            ...
            <div className="product-text">
              <p className="titleAbt">{t("about.1res")} </p>
              <p>{t("about.1par")}</p>
            </div>
          </div>
        </div>
        <div className="secondBlockIcons">
          ...
          <div className="product-text">
            <p className="titleAbt">{t("about.2res")}</p>
            <p>{t("about.2par")}</p>
          </div>
        </div>
      </div>
      <div className="containerAbout-3">
        <div className="thirdBlockIcons">
          <div className="product-text">
            ...
            <p className="titleAbt">{t("about.3res")}</p>
            <p>{t("about.3par")}</p>
          </div>
        </div>
        <div className="fourBlockIcons">
          <div className="product-text">
            ...
            <p className="titleAbt">{t("about.4res")}</p>
            <p>{t("about.4par")}</p>
          </div>
        </div>
      </div>
