  ...
  return (
    <div className="oferta-conteiner">
      ...
      <p>
        ...
        відповідно до статті 633 Цивільного кодексу України його умови однакові
        для всіх покупців незалежно від статусу (фізична особа, юридична особа,
        фізична особа – підприємець). При повній згоді з даним Договором,
        покупець приймає умови і порядок оформлення замовлення, оплати товару,
        доставки товару. Цей Договір є угодою між інтернет-магазином
        «www.tomatina.ua») (надалі по тексту – «Продавець») і будь-якою
        юридичною особою, фізичною особою-підприємцем або фізичною особою,
        користувачем послуг інтернет-магазину, яка надалі іменується “Покупець”
        (надалі – «Покупець»), що включає всі суттєві умови організації купівлі
      ...
      <p>
        ...
        визначаються Законом України «Про захист прав споживачів» № 1023-XII від
        12 травня 1991 року, Правилами роздрібної торгівлі непродовольчими
        товарами, затвердженими наказом Міністерства економіки України № 104 від
        19 квітня 2007 року.
      </p>
      <p>
      ...
      <p>
        1.1. Цей договір є публічною офертою ( відповідно до ст. 633, 641 і гл.
        63 Цивільного кодексу України) і містить всі істотні умови організації
      ...
      <p>
        ...
        права, встановлені Законом України «Про захист персональних даних», про
        цілі збору даних. Обсяг прав Покупця, як суб’єкта персональних даних
        відповідно до Закону України «Про захист персональних даних», йому
        відомий і зрозумілий.{" "}
      </p>
      <p>2. Терміни та визначення </p>
      <p>
        2.1. «Інтернет – магазин» -сайт Продавця («www.tomatina.ua»), створений
        для укладення договорів роздрібної та оптової купівлі – продажу на
        підставі ознайомлення Покупця з запропонованим Продавцем описом Товару
        на фотознімках, за допомогою мережі Інтернет, що виключає можливість
        безпосереднього ознайомлення Покупця з Товаром – дистанційним засобом
        продажу товару.{" "}
      </p>
      <p>
      ...
      <p>
        г) виконання і передача замовлення Покупцеві у власність на умовах Цього
        договору.{" "}
      </p>
      <p>4. Порядок оформлення замовлення </p>
      <p>
        4.1. Покупець самостійно оформляє замовлення онлайн в інтернет-магазині
        або за допомогою телефонних засобів зв’язку за контактами, вказаними в
        інтернет-магазині.
      </p>
      ...
      <p>
        ...
        той вже прийняв умови Продавця та здійснив у встановленому цим договором
        порядку оплату Товару (послуг).
      </p>{" "}
      <p>
        {" "}
      ...
      <p>
        ...
        транспортної компанії (перевізником) за рахунок Покупця. Загальний строк
        доставки не може перевищувати 10 днів.
      </p>{" "}
      <p>
      ...
      <p>
        {" "}
        6.6. Оплата вартості доставки здійснюється Покупцем Компанії-перевізнику
        самостійно, при отриманні товару. Точна вартість доставки визначається
        Компанією-перевізником.{" "}
      </p>{" "}
      <p> 7. Повернення товару належної якості</p>{" "}
      <p>
        {" "}
        7.1. Покупець має право обміняти Товар належної якості на аналогічний у
        ...
        може бути ним використаний за призначенням за наступними умовами:{" "}
      </p>{" "}
      <p>
        {" "}
      ...
      <p>
        {" "}
        7.5. Якщо на момент обміну аналогічного товару немає у продажу, Покупець
      ...
      <p> 8. Права та обов’язки сторін </p> <p> 8.1. Покупець зобов’язаний: </p>{" "}
      <p>
      ...
      <p>
        ...
        пошкоджень та неповної комплектації – зафіксувати їх в акті, який разом
        із Покупцем повинен підписати співробітник перевізника.
      </p>{" "}
      <p>
        {" "}
      ...
      <p>
        {" "}
        б) передати Покупцю товар у відповідності з обраним зразком, розміщеним
      ...
      <p>
        ...
        відповідача у суді і не відшкодовує збитки, що виникли у Покупця через
        дію чи бездіяльність третіх осіб.
      </p>{" "}
      <p> 9. Порядок прийому товару Покупцем </p>{" "}
      <p>
        {" "}
        9.1. При отриманні Товару на складі перевізника, від кур’єра або
        Продавця, Покупець зобов’язаний перевірити зовнішню цілісність упаковки,
        після чого відкрити її та безпосередньо пересвідчитися у належному
        зовнішньому стані Товару (відсутності механічних пошкоджень) та повноті
        його комплектності.
      </p>{" "}
      <p>
        {" "}
        9.2. У випадку наявності хоча б одного з перерахованих в п.9.1. Договору
        недоліків, Покупець зобов’язаний зафіксувати його у складеному акті
        довільної форми. Акт повинен бути підписаний Покупцем та співробітником
        перевізника або Продавця..Протягом 1 (одного) дня з моменту підписання
        Акту Покупець зобов’язаний повідомити менеджера (представника Продавця
        відповідального за оформлення замовлення на Товар) про виявлені недоліки
        та домовитися про заміну Товару.
      </p>{" "}
      ...
      <p>
        {" "}
        10.3. Сторона, що посилається на дію обставин непереборної сили повинна
      ...
      <p>
        {" "}
        11.2. Інтернет – магазин створений для організації дистанційного способу
        продажу товарів через Інтернет.
      </p>{" "}
      <p>
        {" "}
        11.3. Інтернет – магазин не несе відповідальність за зміст і правдивість
      ...
      <p>
        ...
        реєстрації в інтернет-магазині «www.tomatina.ua» і діє до виконання всіх
        умов договору.
      </p>
      </div>
    </div>
