...
import TranslateBtn from "../Translate/translateBtn";
    ...
    <div className="app-header-content">
      ...
      <button className='changeLanguage' onClick={() => handleClick("en")}>ENG</button>
        ...
        <button className="app-header-content-response">
          {" "}
          <Link className="btn_comment" to="/comment">
        ...
        <Tooltip
          ...
          Працюємо Пн - Нд з 08:30 до 22:00"
          interactive
        >
          <Button>
            <Link className="icons-heart" to="/contacts">
              <svg
                className="bg"
                width="47"
                height="45"
